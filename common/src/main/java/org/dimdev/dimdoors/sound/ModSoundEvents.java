...
public final class ModSoundEvents {
    ...
    public static final SoundEvent THEY_STARE_BACK = register("they_stare_back");

    private static SoundEvent register(String id) {
        return DimensionalDoors.getSided().register(Registries.SOUND_EVENT, id, SoundEvent.createVariableRangeEvent(DimensionalDoors.id(id)));
    }
