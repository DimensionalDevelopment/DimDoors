...
public interface PocketAddon {
	...
	record PocketAddonType<T extends PocketAddon, V extends PocketBuilderAddon<T, V>>(ResourceLocation id, @NotNull MapCodec<T> codec, @Nullable StreamCodec<RegistryFriendlyByteBuf, T> streamCodec, MapCodec<V> builderMapCodec) {
		...
		public static final RegistrySupplier<PocketAddonType<PreventBlockModificationAddon, PreventBlockModificationAddon.PreventBlockModificationBuilderAddon>> PREVENT_BLOCK_MODIFICATION_ADDON = register(PreventBlockModificationAddon.ID,  PreventBlockModificationAddon.CODEC, PreventBlockModificationAddon.STREAM_CODEC, PreventBlockModificationAddon.PreventBlockModificationBuilderAddon.CODEC);
