...
public interface WeatherData {
    ...
    public record WeatherDataType<T extends WeatherData>(MapCodec<T> codec, StreamCodec<RegistryFriendlyByteBuf, T> streamCodec) {
        ...
        private static final Map<ResourceLocation, WeatherDataType<?>> ID_TO_TYPE = new HashMap<>();
        private static final Map<WeatherDataType<?>, ResourceLocation> TYPE_TO_ID = new HashMap<>();

        public static Codec<WeatherDataType<?>> CODEC = ResourceLocation.CODEC.xmap(ID_TO_TYPE::get, TYPE_TO_ID::get);
        public static StreamCodec<RegistryFriendlyByteBuf, WeatherDataType<?>> STREAM_CODEC = ResourceLocation.STREAM_CODEC.<RegistryFriendlyByteBuf>cast().map(ID_TO_TYPE::get, TYPE_TO_ID::get);
        ...
        public static <U extends WeatherData> WeatherDataType<U> register(ResourceLocation id, MapCodec<U> codec, StreamCodec<RegistryFriendlyByteBuf, U> streamCodec) {
