...
public interface SkyData {
    ...
    public record SkyDataType<T extends SkyData>(MapCodec<T> codec, StreamCodec<RegistryFriendlyByteBuf, T> streamCodec) {
        ...
        private static final Map<ResourceLocation, SkyDataType<?>> ID_TO_TYPE = new HashMap<>();
        private static final Map<SkyDataType<?>, ResourceLocation> TYPE_TO_ID = new HashMap<>();

        public static Codec<SkyDataType<?>> CODEC = ResourceLocation.CODEC.xmap(ID_TO_TYPE::get, TYPE_TO_ID::get);
        public static StreamCodec<RegistryFriendlyByteBuf, SkyDataType<?>> STREAM_CODEC = ResourceLocation.STREAM_CODEC.<RegistryFriendlyByteBuf>cast().map(ID_TO_TYPE::get, TYPE_TO_ID::get);
        ...
        public static <U extends SkyData> SkyDataType<U> register(ResourceLocation id, MapCodec<U> codec, StreamCodec<RegistryFriendlyByteBuf, U> streamCodec) {
