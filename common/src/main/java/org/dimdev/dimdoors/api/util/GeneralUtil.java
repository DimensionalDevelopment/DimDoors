...
public class GeneralUtil {
    public static final Codec<CompoundTag> RIFT_DATA_CODEC = Codec.either(Codec.STRING, CompoundTag.CODEC).xmap(either -> either.map(PocketLoader.getInstance()::getDataNbtCompound, Function.identity()), Either::right);
