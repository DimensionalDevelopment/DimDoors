...
public class GeneralUtil {
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, Identifier> RESOURCE_LOCATION_STREAM_CODEC = StreamCodec.ofMember((value, buf) -> buf.writeIdentifier(value), FriendlyByteBuf::readIdentifier);
