...
public class ClothConfigCompat {
    ...
    public static Screen createScreen(Screen parent) {
            ...
            builder.getOrCreateCategory(Component.translatable("config.dimdoors.general.category"))
            ...
            builder.getOrCreateCategory(Component.translatable("config.dimdoors.pockets.category"))
            ...
            builder.getOrCreateCategory(Component.translatable("config.dimdoors.world.category"))
            ...
            builder.getOrCreateCategory(Component.translatable("config.dimdoors.dungeons.category"))
            ...
            builder.getOrCreateCategory(Component.translatable("config.dimdoors.monoliths.category"))
            ...
            builder.getOrCreateCategory(Component.translatable("config.dimdoors.doors.category"))
            ...
            builder.getOrCreateCategory(Component.translatable("config.dimdoors.decay.category"))
    ...
    private static @NotNull AbstractConfigListEntry<?> createDouble(ConfigEntryBuilder builder, String category, String name, double value, double defaultValue, Consumer<Double> consumer) {
        var langEntry = "config.dimdoors." + category + ".option." + name;
    ...
    private static @NotNull AbstractConfigListEntry<?> createFloat(ConfigEntryBuilder builder, String category, String name, float value, float defaultValue, Consumer<Float> consumer) {
        var langEntry = "config.dimdoors." + category + ".option." + name;
    ...
    private static @NotNull AbstractConfigListEntry<?> createBoolean(ConfigEntryBuilder builder, String category, String name, boolean value, boolean defaultValue, Consumer<Boolean> consumer) {
        var langEntry = "config.dimdoors." + category + ".option." + name;
    ...
    private static @NotNull AbstractConfigListEntry<?> createInt(ConfigEntryBuilder builder, String category, String name, int value, int defaultValue, Consumer<Integer> consumer) {
        var langEntry = "config.dimdoors." + category + ".option." + name;
    ...
    private static <T extends Enum<T>> @NotNull AbstractConfigListEntry<?> createEnum(ConfigEntryBuilder builder, String category, String name, Class<T> enumClass, T value, T defaultValue, Consumer<T> consumer) {
        var langEntry = "config.dimdoors." + category + ".option." + name;
    ...
    private static @NotNull AbstractConfigListEntry<?> createStringList(ConfigEntryBuilder builder, String category, String name, Collection<String> value, Collection<String> defaultValue, Consumer<List<String>> consumer) {
        var langEntry = "config.dimdoors." + category + ".option." + name;
    ...
    private static @NotNull AbstractConfigListEntry<?> createLevelKey(ConfigEntryBuilder builder, String category, String name, @Nullable ResourceKey<Level> value, @Nullable ResourceKey<Level> defaultValue, Consumer<ResourceKey<Level>> consumer) {
        var langEntry = "config.dimdoors." + category + ".option." + name;
    ...
    private static @NotNull AbstractConfigListEntry<?> createLevelKeyList(ConfigEntryBuilder builder, String category, String name, List<ResourceKey<Level>> value, List<ResourceKey<Level>> defaultValue, Consumer<List<ResourceKey<Level>>> consumer) {
        var langEntry = "config.dimdoors." + category + ".option." + name;
