package org.dimdev.limlib.api.util.math;
...
public interface Equation {
    Codec<Equation> CODEC = Codec.withAlternative(Codec.STRING, Codec.INT, Object::toString).xmap(Equation::parseOrCrash, Equation::asString);

    Equation ZERO = Equation.parseOrCrash("0");
    Equation FIVE = Equation.parseOrCrash("5");
    Equation ONE = Equation.parseOrCrash("1");
