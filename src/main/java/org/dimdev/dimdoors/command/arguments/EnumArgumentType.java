...
public class EnumArgumentType<T extends Enum<T>> implements ArgumentType<T> {
	public static final DynamicCommandExceptionType UNKNOWN_VALUE = new DynamicCommandExceptionType(str -> MutableComponent.create(new TranslatableContents("commands.generic.unknownValue", str)));
