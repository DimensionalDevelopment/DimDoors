...
public final class ModFeatures {
    ...
    public static final ConfiguredFeature<?, ?> SANDSTONE_PILLARS_FEATURE = GATEWAY_FEATURE.configure(GatewayFeatureConfig.SANDSTONE_PILLARS_CONFIG).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(5)));
    public static final ConfiguredFeature<?, ?> TWO_PILLARS_FEATURE = GATEWAY_FEATURE.configure(GatewayFeatureConfig.TWO_PILLARS_CONFIG).decorate(Decorator.CHANCE.configure(new ChanceDecoratorConfig(4)));
