...
import org.dimdev.dimdoors.util.BaseConfigurationProcessor;
import org.dimdev.dimdoors.util.ConfigurationProcessingException;
import org.dimdev.dimdoors.util.JSONValidator;
...
public class DimDataProcessor extends BaseConfigurationProcessor<PackedDimData> {
    ...
    private final HashMap<Integer, JsonObject> SAVE_DATA_SCHEMA;
