...
import org.dimdev.dimdoors.dungeon.pack.DungeonPackConfig;
...
public class DungeonHelper {
    ...
    private final ArrayList<DungeonData> untaggedDungeons = new ArrayList<DungeonData>();
    private final ArrayList<DungeonData> registeredDungeons = new ArrayList<DungeonData>();

    private DungeonPack RuinsPack;
    private DungeonPack NetherPack;
    private final HashMap<String, DungeonPack> dungeonPackMapping = new HashMap<String, DungeonPack>();
    private final ArrayList<DungeonPack> dungeonPackList = new ArrayList<DungeonPack>();
