...
public class DimdoorsRecipeProvider extends RecipeProvider {
	...
	public void buildRecipes(Consumer<FinishedRecipe> exporter) {
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlocks.TESSELATING_LOOM.get()).pattern("###").pattern("XAX").pattern("#B#").define('#', ModItems.WORLD_THREAD.get()).define('A', Blocks.LOOM).define('B', Items.IRON_INGOT).unlockedBy("inventory_changed", InventoryChangeTrigger.TriggerInstance.hasItems(Blocks.LOOM)).save(exporter, DimensionalDoors.id("tesselating_loom"));
