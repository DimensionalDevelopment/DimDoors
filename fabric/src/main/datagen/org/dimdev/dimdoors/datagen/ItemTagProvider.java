...
public class ItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void addTags(HolderLookup.Provider arg) {
        this.tag(ItemTags.MUSIC_DISCS).add(ModItems.CREEPY_RECORD.getOrNull().builtInRegistryHolder().key(), ModItems.WHITE_VOID_RECORD.getOrNull().builtInRegistryHolder().key(), ModItems.THEY_STARE_BACK_RECORD.getOrNull().builtInRegistryHolder().key());
        this.tag(ItemTags.TRIMMABLE_ARMOR).add(
            ModItems.WORLD_THREAD_BOOTS.getKey(),
            ModItems.WORLD_THREAD_CHESTPLATE.getKey(),
            ModItems.WORLD_THREAD_HELMET.getKey(),
            ModItems.WORLD_THREAD_LEGGINGS.getKey(),
            ModItems.GARMENT_OF_REALITY_BOOTS.getKey(),
            ModItems.GARMENT_OF_REALITY_CHESTPLATE.getKey(),
            ModItems.GARMENT_OF_REALITY_HELMET.getKey(),
            ModItems.GARMENT_OF_REALITY_LEGGINGS.getKey()
        );
