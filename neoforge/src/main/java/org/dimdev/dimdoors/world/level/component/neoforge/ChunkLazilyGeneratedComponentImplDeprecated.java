...
public class ChunkLazilyGeneratedComponentImplDeprecated {
    ...
    public static class Provider implements ICapabilityProvider, INBTSerializable<CompoundTag> {
        ...
        public @NotNull <T> LazyOptional<T> getCapability(@NotNull Capability<T> capability, @Nullable Direction arg) {
            return ChunkLazilyGeneratedComponentImplDeprecated.INSTANCE.orEmpty(capability, optionalData);
        }
        ...
        public static void attach(final AttachCapabilitiesEvent<LevelChunk> event) {
            ...
            event.addCapability(ChunkLazilyGeneratedComponentImplDeprecated.IDENTIFIER, provider);
        }
    }
}
