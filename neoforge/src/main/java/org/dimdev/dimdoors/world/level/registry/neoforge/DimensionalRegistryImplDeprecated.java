...
public class DimensionalRegistryImplDeprecated {
    ...
    public static class Provider implements ICapabilityProvider, INBTSerializable<CompoundTag> {
        ...
        public @NotNull <T> LazyOptional<T> getCapability(@NotNull Capability<T> capability, @Nullable Direction arg) {
            return DimensionalRegistryImplDeprecated.INSTANCE.orEmpty(capability, optionalData);
        }
        ...
        public static void attach(final AttachCapabilitiesEvent<Level> event) {
            if(DimensionalRegistry.isValidWorld(event.getObject())) {
                final DimensionalRegistryImplDeprecated.Provider provider = new DimensionalRegistryImplDeprecated.Provider();

                event.addCapability(DimensionalRegistryImplDeprecated.IDENTIFIER, provider);
            }
        }
    }
}
